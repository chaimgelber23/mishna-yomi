...
export const MISHNA_STRUCTURE_RAW = [
  ...
  { seder: "Zeraim", tractate: "Kilayim",      chapters: [9,11,7,9,8,9,8,6,10] },
  ...
  // Seder Moed
  { seder: "Moed", tractate: "Shabbat",        chapters: [11,7,6,2,4,10,4,7,7,6,6,6,7,4,3,8,8,3,6,5,3,6,5,5] },
  ...
  { seder: "Moed", tractate: "Rosh Hashanah",  chapters: [9,9,8,9] },
  ...
  // Seder Nashim
  { seder: "Nashim", tractate: "Yevamot",      chapters: [4,10,10,13,6,6,6,6,6,9,7,6,13,9,10,7] },
  { seder: "Nashim", tractate: "Ketubot",      chapters: [10,10,9,12,9,7,10,8,9,6,6,4,11] },
  { seder: "Nashim", tractate: "Nedarim",      chapters: [4,5,11,8,6,10,9,7,10,8,12] },
  { seder: "Nashim", tractate: "Nazir",        chapters: [7,10,7,7,7,11,4,2,5] },
  { seder: "Nashim", tractate: "Sotah",        chapters: [9,6,8,5,5,4,8,7,15] },
  { seder: "Nashim", tractate: "Gittin",       chapters: [6,7,8,9,9,7,9,10,10] },
  { seder: "Nashim", tractate: "Kiddushin",    chapters: [10,10,13,14] },
  ...
  { seder: "Nezikin", tractate: "Sanhedrin",   chapters: [6,5,8,5,5,6,11,7,6,6,6] },
  ...
  { seder: "Kodashim", tractate: "Menachot",   chapters: [4,5,7,5,9,7,6,7,9,9,9,5,11] },
  { seder: "Kodashim", tractate: "Chullin",    chapters: [7,10,7,7,5,7,6,6,8,4,2,5] },
  { seder: "Kodashim", tractate: "Bekhorot",   chapters: [7,9,4,10,6,12,7,10,8] },
  { seder: "Kodashim", tractate: "Arakhin",    chapters: [4,6,5,4,6,5,5,7,8] },
  { seder: "Kodashim", tractate: "Temurah",    chapters: [6,3,5,4,6,5,6] },
  { seder: "Kodashim", tractate: "Keritot",    chapters: [7,6,10,3,8,9] },
  { seder: "Kodashim", tractate: "Me'ilah",    chapters: [4,9,8,6,5,6] },
  ...
  { seder: "Taharot", tractate: "Ohalot",      chapters: [8,7,7,3,7,7,6,6,16,7,9,8,6,7,10,5,5,10] },
  { seder: "Taharot", tractate: "Nega'im",     chapters: [6,5,8,11,5,8,5,10,3,10,12,7,12,13] },
  { seder: "Taharot", tractate: "Parah",       chapters: [4,5,11,4,9,5,12,11,9,6,9,11] },
  { seder: "Taharot", tractate: "Tahorot",     chapters: [9,8,8,13,9,10,9,9,9,8] },
